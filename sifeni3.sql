...
--
-- Dumping data untuk tabel `sf_fenomena`
--

INSERT INTO `sf_fenomena` (`id`, `tanggal_fenomena`, `sumber_id`, `kecamatan_id`, `isi_fenomena`, `lapangan_usaha`, `pengaruh_id`, `tanggal_entri`, `upload_foto_dokumen`, `isVerified`) VALUES
(1, '0000-00-00', 1, 7403, 'pkpoop', 1, 1, '0000-00-00', 'mio,o,op  omomok,ok,', 0),
(2, '2017-11-01', 1, 7403091, 'sdf', 10, 1, '2017-11-14', 'dsfsd', 0),
(3, '2017-11-01', 1, 7412, 'grdgd', 2, 2, '2017-11-01', 'dfgdfg', 0),
(5, '2017-11-01', 1, 7403, 'uui', 1, 1, '2017-11-01', 'jgjgfj', 0),
(6, '2017-11-02', 1, 7403, 'asdsf', 1, 1, '2017-11-01', 'sdfdsfsd', 0);
...
ALTER TABLE `sf_fenomena`
  ...
  ADD KEY `lapangan_usaha` (`lapangan_usaha`);
...
ALTER TABLE `sf_fenomena`
  ...
  ADD CONSTRAINT `sf_fenomena_ibfk_5` FOREIGN KEY (`kecamatan_id`) REFERENCES `sf_kecamatan` (`id`),
  ADD CONSTRAINT `sf_fenomena_ibfk_6` FOREIGN KEY (`lapangan_usaha`) REFERENCES `sf_lapangan_usaha` (`id`);
